...
df1 = pd.read_csv("../results/aspect_ratios_initial.csv")
...
df2 = pd.read_csv("../results/aspect_ratios_lloyd.csv")
...
df3 = pd.read_csv("../results/aspect_ratios_equilateral.csv")
...
plt.legend()
# Save plot
plt.savefig("aspect_ratio_point-set_80_837b0f11.png", dpi=600, bbox_inches='tight')